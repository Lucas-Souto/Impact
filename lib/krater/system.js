...
class System
{
	static SCALE =
	{
		...
		{
			KG.setVendorAttribute(context, 'imageSmoothingEnabled', false);
		...
		{
			KG.setVendorAttribute(context, 'imageSmoothingEnabled', true);
	...
	{
		KG.game = new (gameClass)();

		KG.system.setDelegate(KG.game);
		this.onGameSet();
	}
	...
	stopRunLoop()
	{
		KG.clearAnimation(this.animationId);
	...
	startRunLoop()
	{
		...
		this.animationId = KG.setAnimation(this.run.bind(this));
		this.running = true;
	}
