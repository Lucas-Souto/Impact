...
// Merge the ImpactMixin - if present - into the 'kg' namespace. This gives other
// code the chance to modify 'kg' before it's doing any work.
if(window.ImpactMixin) KG.merge(KG, window.ImpactMixin);
