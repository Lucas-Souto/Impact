...
class KG
{
	...
	static main(canvasId, gameClass, fps, width, height, scale, inputClass, loaderClass)
	{
		KG.system = new System(canvasId, fps, width, height, scale || 1);
		KG.input = new (inputClass || Input)();
	...
	static boot()
	{
		...
		KG.ua.screen =
		{
			width: window.screen.availWidth * KG.ua.pixelRatio,
			height: window.screen.availHeight * KG.ua.pixelRatio
		};
