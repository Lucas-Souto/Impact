...
class Font extends KGImage
{
	...
	_drawChar(c, targetX, targetY)
	{
		...
		const context = KG.system.context;
		...
		if (this.color !== null)
		{
			...
			tempContext.fillRect(0, 0, charWidth, charHeight);
			
			tempContext.globalCompositeOperation = "destination-in";
			
			tempContext.drawImage(this.data, charX, charY, charWidth, charHeight, 0, 0, charWidth, charHeight);

			context.drawImage(tempCanvas, KG.system.getDrawPos(targetX), KG.system.getDrawPos(targetY));
		}
		else context.drawImage(this.data, charX, charY, charWidth, charHeight, KG.system.getDrawPos(targetX), KG.system.getDrawPos(targetY), charWidth, charHeight);
